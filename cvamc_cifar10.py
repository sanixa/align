...
scaler = Scaler()
mc1_z_mean = scaler(mc1_z_mean, mode='positive', name='Scaler')
mc1_z_log_var = scaler(mc1_z_log_var, mode='negative', name='Scaler')
z_mean = scaler(z_mean, mode='positive', name='Scaler')
z_log_var = scaler(z_log_var, mode='negative', name='Scaler')
...
mean_encoder.save('model/cifar10/mean_encoder_scale.h5')

var_encoder = Model(x_in, z_plus_log_var)
var_encoder.save('model/cifar10/var_encoder_scale.h5')

decoder.save('model/cifar10/generator_scale.h5')

mu = Model(y, yh)
mu.save('model/cifar10/y_encoder_scale.h5')
