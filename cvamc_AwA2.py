...
mean_encoder.save('model/AwA2/mean_encoder_scale.h5')

var_encoder = Model(x_in, z_plus_log_var)
var_encoder.save('model/AwA2/var_encoder_scale.h5')

decoder.save('model/AwA2/generator_scale.h5')

mu = Model(y_in, yh)
mu.save('model/AwA2/y_encoder_scale.h5')
