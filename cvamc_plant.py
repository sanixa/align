...
y_class_train = np.repeat(a=temp, repeats=2000*(num_classes-num_unseen_classes), axis=0).reshape(2000*(num_classes-num_unseen_classes),num_classes,num_classes)
y_class_test =  np.repeat(a=temp, repeats=500*(num_classes-num_unseen_classes), axis=0).reshape(500*(num_classes-num_unseen_classes),num_classes,num_classes)
